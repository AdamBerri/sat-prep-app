...
export const metadata: Metadata = {
  title: "SAT Prep Articles & Strategies | 1600Club",
  description:
    "Expert SAT prep strategies, study tips, and test-taking advice to help you achieve your best score. Free resources from 1600Club.",
  openGraph: {
    title: "SAT Prep Articles & Strategies | 1600Club",
